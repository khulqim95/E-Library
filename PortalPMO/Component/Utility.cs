...
namespace PortalPMO.Component
{
    public class Utility
    {
        ...
        public static IEnumerable<TblLookup> SelectLookup(string Type, dbPortalPMOContext _context)
        {
        ...
        public static string SelectLookupName(string Type,int? Value, dbPortalPMOContext _context)
        {
        ...
        public static string SelectProjectStatusName(int? Id, dbPortalPMOContext _context)
        {
        ...
        public static IEnumerable<DataDropdownClientSide> SelectTypeDokumen(dbPortalPMOContext _context)
        {
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataMasterRole(dbPortalPMOContext _context)
        {
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataMasterRoleById(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataMenu(dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataUnit(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataUnitByWilayahId(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataMasterSistem(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataTypeClient(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataClient(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataPegawai(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataRM(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataProject(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataJobPosition(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataKlasifikasiProject(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataKompleksitasProject(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataKategoriProject(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataSubKategoriProject(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static IEnumerable<DataDropdownServerSide> SelectDataSkorProject(int? Id, dbPortalPMOContext _context)
        {
            List<DataDropdownServerSide> data = new List<DataDropdownServerSide>();
        ...
        public static string GenerateNoProject(dbPortalPMOContext _context)
        {
