...
namespace PortalPMO.Controllers
{
    public class PendingTaskController : Controller
    {
        ...
        public PendingTaskController(IConfiguration config, dbPortalPMOContext context, IHttpContextAccessor accessor)
        {
            _context = context;
        ...
        public ActionResult SubmitCreateProgressPekerjaan(ProgressKerjaMember_ViewModels model)
        {
            ...
            try
            {
                ...
                using (TransactionScope trx = new TransactionScope())
                {
                    ...
                    //dataLog.ProjectId = model.ProjectMemberId;
                    ...
                    //dataLog.Komentar = GetConfig.AppSetting["AppSettings:DetailPekerjaanLog:TambahData"];
