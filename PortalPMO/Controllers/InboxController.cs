...
namespace PortalPMO.Controllers
{
    public class InboxController : Controller
    {
        ...
        public InboxController(IConfiguration config, dbPipelineContext context, IHttpContextAccessor accessor)
        {
            _context = context;
        ...
        public IActionResult LoadData()
        {
            ...
            try
            {
                ...
                list = StoredProcedureExecutor.ExecuteSPList<InboxPipeline_ViewModels>(_context, "sp_InboxPipeline_View", new SqlParameter[]{
                ...
                recordsTotal = StoredProcedureExecutor.ExecuteScalarInt(_context, "[sp_InboxPipeline_Count]", new SqlParameter[]{
                          new SqlParameter("@NamaDebitur", NamaSearchParam),
                        new SqlParameter("@Cif", KeteranganSearchParam),
                        new SqlParameter("@RoleId", HttpContext.Session.GetString(SessionConstan.Session_Role_Id)),
                        new SqlParameter("@UserId", HttpContext.Session.GetString(SessionConstan.Session_Pegawai_Id))});
        ...
        public IActionResult LoadDataTableFasilitasKredit(string Id)
        {
            ...
            try
            {
                ...
                //error value convert value p01 into int
                //recordsTotal = StoredProcedureExecutor.ExecuteScalarInt(_context, "[sp_FasilitasKreditPipeline_Count]", new SqlParameter[]{
                //        new SqlParameter("@Id", Id)});
        ...
        #region View
        public ActionResult View(int LeadsId, int KategoriLeadsId, string NoPengajuan)
        {
            if (!lastSession.Update())
            {
                return RedirectToAction("Login", "Login", new { a = true });
            ...
            data = StoredProcedureExecutor.ExecuteSPSingle<DetailPipeline_ViewModels>(_context, "sp_InfoDebiturNew_GetDataById", new SqlParameter[]{
                        //new SqlParameter("@Id", LeadsId),
                        new SqlParameter("@Nopengajuan", NoPengajuan)
