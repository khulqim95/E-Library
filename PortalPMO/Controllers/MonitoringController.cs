...
namespace TwoTierTemplate.Controllers
{
    public class MonitoringController : Controller
    {
        ...
        public MonitoringController(IConfiguration config, dbPipelineContext context, IHttpContextAccessor accessor)
        {
            _context = context;
        ...
        public IActionResult LoadData()
        {
            ...
            try
            {
                ...
                list = StoredProcedureExecutor.ExecuteSPList<InboxPipeline_ViewModels>(_context, "sp_Monitoring_View", new SqlParameter[]{
                ...
                recordsTotal = StoredProcedureExecutor.ExecuteScalarInt(_context, "[sp_Monitoring_Count]", new SqlParameter[]{
                          new SqlParameter("@NamaDebitur", NamaSearchParam),
                        new SqlParameter("@Cif", KeteranganSearchParam),
                        new SqlParameter("@RoleId", HttpContext.Session.GetString(SessionConstan.Session_Role_Id)),
                        new SqlParameter("@UserId", HttpContext.Session.GetString(SessionConstan.Session_Pegawai_Id))});
