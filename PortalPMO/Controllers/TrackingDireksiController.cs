...
{
    public class TrackingDireksiController : Controller
    {
        ...
        public TrackingDireksiController(IConfiguration config, dbPortalPMOContext context, IHttpContextAccessor accessor)
        {
            _context = context;
        ...
        public IActionResult LoadDataTableProspek(string UnitId, string UserId)
        {
            ...
            try
            {
                ...
                {
                    List<TwoTierTemplate.ViewModels.TblProspek_ViewModels> list = new List<TwoTierTemplate.ViewModels.TblProspek_ViewModels>();
                    list = StoredProcedureExecutor.ExecuteSPList<TwoTierTemplate.ViewModels.TblProspek_ViewModels>(_context, "[sp_Dashboard_ProspekByRM_View]", new SqlParameter[]{
                        new SqlParameter("@RmId", UnitId),
                        new SqlParameter("@sortColumn", "Id"),
                        new SqlParameter("@sortColumnDir", "desc"),
                        new SqlParameter("@PageNumber", pageNumber),
        ...
        public IActionResult LoadDataTablePipeline(string UnitId, string UserId)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    list = StoredProcedureExecutor.ExecuteSPList<TwoTierTemplate.ViewModels.TblPipeline_ViewModels>(_context, "[sp_Dashboard_PipelineByRM_View]", new SqlParameter[]{
                        new SqlParameter("@RmId", UnitId),
                        new SqlParameter("@sortColumn", "Id"),
                        new SqlParameter("@sortColumnDir", "desc"),
                        new SqlParameter("@PageNumber", pageNumber),
