#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\MasterSkorProject\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "98c80278eabc8083445224a2fdb27be078c7f7da"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_MasterSkorProject__Script), @"mvc.1.0.view", @"/Views/MasterSkorProject/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/MasterSkorProject/_Script.cshtml", typeof(AspNetCore.Views_MasterSkorProject__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"98c80278eabc8083445224a2fdb27be078c7f7da", @"/Views/MasterSkorProject/_Script.cshtml")]
    ...
    public class Views_MasterSkorProject__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 15026, true);
  ...
  ");
            WriteLiteral(@"                      retrieve: true,
                        ...
                        //data: data,
                        ajax: {
                            ""url"": '../MasterSkorProject/LoadData',
                            ""type"": ""POST"",
                            ""datatype"": ""json"",
                        ...
                        columns: [
                            { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                            {
                                ...
                                ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                    return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" on");
            WriteLiteral(@"click=""Edit(' + full.Id + ')"" style=""margin-right:5px;"" data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                            ...
                            { responsivePriority: 3, ""data"": ""Skor"", ""name"": ""Skor"" },
    ...
    ");
            WriteLiteral(@"                        {
                            ...
                            { responsivePriority: 8, ""data"": ""CreatedBy"", ""name"": ""CreatedBy"", ""visible"": false },
                            { responsivePriority: 9, ""data"": ""UpdatedTime"", ""name"": ""UpdatedTime"", ""visible"": fa");
            WriteLiteral(@"lse },
                            { responsivePriority: 10, ""data"": ""UpdatedBy"", ""name"": ""UpdatedBy"", ""visible"": false }
                        ],
                        ""order"": [[1, ""desc""]]
                    });
                    ...
                    $('#BtnClearSearch').click(function () {
                        ...
                        T");
            WriteLiteral(@"able.columns(3).search($('#txtNamaSearchParam').val().trim());
                        //hit search ke server
                        Table.draw();
                    });
    ...
    function Create() {
        ...
        State = ""create"";
        UrlPartialView = '../MasterSkorProject/Create';
            ...
            success: function (hasil) {
                if (hasil == true) {
                    LoadPartialViewData(UrlPartialView, function (data) {
                        //ShowModal('bd-example-modal-lg');
                        $('#DivContentBody').hide();
                        document.getElementById(""DivFormBod");
            WriteLiteral(@"y"").innerHTML = data;
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""edit"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../MasterSkorProject/Edit';
                    LoadPartialViewData(UrlPartialView, function (data) {
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""view"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../MasterSkorProject/View';
           ");
 ...
 ");
        ...
        $('#BtnSubmit').click(function () {
            ...
            if (!$valid) {
                ...
                if (State == ""edit"") {
                    url = '../MasterSkorProject/SubmitEdit';
                }
                else {
                    url = '../MasterSkorProject/SubmitCreate';
                }
        ...
        State = ""delete"";
           swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '../MasterSkorProject/Delete',
                            type: 'POST',
          ");
            WriteLiteral(@"                  data: { ""Ids"": Id },
                            success: function (d) {
                                if (d == """") {
