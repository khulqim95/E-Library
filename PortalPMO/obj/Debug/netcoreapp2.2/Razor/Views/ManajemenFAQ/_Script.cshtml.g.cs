#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\ManajemenFAQ\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4ed50289f09db96ac5e9a79969905ccf66af9408"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_ManajemenFAQ__Script), @"mvc.1.0.view", @"/Views/ManajemenFAQ/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/ManajemenFAQ/_Script.cshtml", typeof(AspNetCore.Views_ManajemenFAQ__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4ed50289f09db96ac5e9a79969905ccf66af9408", @"/Views/ManajemenFAQ/_Script.cshtml")]
    ...
    public class Views_ManajemenFAQ__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 17717, true);
                        ...
                        columns: [
                            { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                            {
                                ...
                                ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                    return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-smal");
            WriteLiteral(@"l btn-facebook"" id=""button-edit"" onclick=""Edit(' + full.Id + ')"" style=""margin-right:5px;"" data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                            ...
                            { responsivePriority: 4, ""data"": ""Keterangan"", ""name"": ""Keterangan"" },
                            { responsivePriority: 6, ""d");
            WriteLiteral(@"ata"": ""Order_By"", ""name"": ""Order_By"" },
                            {
                            ...
                            { responsivePriority: 10, ""data"": ""Upda");
            WriteLiteral(@"tedTime"", ""name"": ""UpdatedTime"", ""visible"": false },
                    ...
                    $('#BtnSearch').click(function () {
                        Table.columns(2).search($('#txtPertanyaanSearchParam').val().trim());
                    ...
                    $('#BtnClearSearch').click(function () {
                        $('#txtPer");
            WriteLiteral(@"tanyaanSearchParam').val("""");
    ...
    function Create() {
        ...
        State = ""create"";
        UrlPartialView = '../ManajemenFAQ/Create';
...
");
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""edit"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../ManajemenFAQ/Edit';
                    LoadPartialViewData(UrlPartialView, function (data) {
                        ...
                        $('#K");
            WriteLiteral(@"eteranganSummernote').summernote({
                            placeholder: 'Masukkan Jawaban',
                            height: 300,
                            toolbar: [
                                ['style', ['style']],
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""view"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../ManajemenFAQ/View';
                    LoadPartialViewData(UrlPartialView, function (data) {
                        $('#DivContentBody').hide();
                        document.getElementById(""DivFormBody"").innerHTML = data;
    ...
    function ValidationForm() {
        ...
        $('#BtnSubmit').click(function () {
            ...
            $(""#Keterangan"").val(plaintext)
            var url = '';
            var $vali");
            WriteLiteral(@"d = $(""#FormData"").valid();
            if (!$valid) {
                //alert(""False"");
                ...
                if (State == ""edit"") {
                    url = '../ManajemenFAQ/SubmitEdit';
                }
                else {
                    url = '../ManajemenFAQ/SubmitCreate';
                }
