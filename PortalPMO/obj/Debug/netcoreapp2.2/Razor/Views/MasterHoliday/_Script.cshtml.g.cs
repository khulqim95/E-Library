#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\MasterHoliday\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d68deae537f500db49a4d3b785283b0b3ecb5cba"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_MasterHoliday__Script), @"mvc.1.0.view", @"/Views/MasterHoliday/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/MasterHoliday/_Script.cshtml", typeof(AspNetCore.Views_MasterHoliday__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d68deae537f500db49a4d3b785283b0b3ecb5cba", @"/Views/MasterHoliday/_Script.cshtml")]
    ...
    public class Views_MasterHoliday__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 20539, true);
    ...
    $(document).ready(function () {
        ...
        RangeDateDefault('txtTanggalSearchParam');

        //CreateContentTanggal(""txtTanggalSearchParam"");
    });

    function LoadDataTable(data) {
        if (Table != undefined) {
            Table.DataTable.destr");
            WriteLiteral(@"oy();
        }
        ...
        $.ajax({
            ...
            WriteLiteral(@"lass=""btn btn-small btn-facebook"" id=""button-view"" onclick=""View(' + full.Id + ')"" style=""margin-right:5px;"" data-toggle=""tooltip"" title=""View Data""><i class=""fa fa-eye btnView""></i></a>'
   ...
   ");
            WriteLiteral(@"                 });
                    ...
                    $('#BtnSearch').click(function () {
                        ...
                        Table.columns(3).search($('#txtTanggalSearchParam').val().trim());
    ...
    function Create() {
        ...
        State = ""create"";
        UrlPartialView = '../MasterHoliday/Create';
        ...
        $.ajax({
            ...
            WriteLiteral(@"        document.getElementById(""DivFormBody"").innerHTML = data;
                        ...
                        CreateContentTanggal(""Tanggal"");

                        $('#KeteranganSummernote').summern");
            WriteLiteral(@"ote({
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""edit"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../MasterHoliday/Edit';
                    LoadPartialViewData(UrlPartialView, function (data) {
                        ...
                        $.fn.datepicker.language['en'] = {
                            days: ['Minggu', 'Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu'],
                            daysShort: ['Min', 'Sen'");
            WriteLiteral(@", 'Sel', 'Rab', 'Kam', 'Jum', 'Sab'],
                            daysMin: ['Mn', 'Sn', 'Sl', 'Rb', 'Km', 'Jm', 'Sa'],
                            months: ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'],
                            monthsShort: ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Dec'],
                            today: 'Today',
     ...
     ");
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""view"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../MasterHoliday/View';
                    LoadPartialViewData(UrlPartialView, function (data) {
                        $('#DivContentBody').hide();
                        document.getElementById(""DivFormBody"").innerHTML = data;
    ...
    function ValidationForm() {
        ...
        $('#BtnSubmit').click(function () {
            ...
            if (!$valid) {
                ...
                if (State == ""edit"") {
                    url ");
            WriteLiteral(@"= '../MasterHoliday/SubmitEdit';
                }
                else {
                    url = '../MasterHoliday/SubmitCreate';
                }
    ...
    function Delete(Id) {
        ...
        State = ""delete"";
           swal({
                title: ""Konfirmasi"",
                text: ");
            WriteLiteral(@"""Apakah Anda yakin ingin menghapus data ini?"",
                icon: ""warning"",
                buttons: true,
                dangerMode: true,
            })
