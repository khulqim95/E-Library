#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\DataKlasifikasiProject\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4b83fbc9b73b4e875df72920008321b47c93b709"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_DataKlasifikasiProject__Script), @"mvc.1.0.view", @"/Views/DataKlasifikasiProject/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/DataKlasifikasiProject/_Script.cshtml", typeof(AspNetCore.Views_DataKlasifikasiProject__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4b83fbc9b73b4e875df72920008321b47c93b709", @"/Views/DataKlasifikasiProject/_Script.cshtml")]
    ...
    public class Views_DataKlasifikasiProject__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 15402, true);
  ...
  ");
            WriteLiteral(@"                      retrieve: true,
                        ...
                        //data: data,
                        ajax: {
                            ""url"": '../DataKlasifikasiProject/LoadData',
                            ""type"": ""POST"",
                            ""datatype"": ""json"",
                        ...
                        columns: [
                            { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                            {
                                ...
                                ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                    return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edi");
            WriteLiteral(@"t"" onclick=""Edit(' + full.Id + ')"" style=""margin-right:5px;"" data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
           ...
           ");
            WriteLiteral(@"                 { responsivePriority: 10, ""data"": ""UpdatedTime"", ""name"": ""UpdatedTime"", ""visible"": false },
                    ...
                    //---------------------Function");
            WriteLiteral(@" untuk reset data pencarian----------------//
    ...
    function Create() {
        ...
        State = ""create"";
        UrlPartialView = '../DataKlasifikasiProject/Create';
    ...
    function Edit(Id) {
        ...
        $.ajax({
            ...
            WriteLiteral(@"= true) {
                    ...
                    State = ""edit"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../DataKlasifikasiProject/Edit';
                    LoadPartialViewData(UrlPartialView, function (data) {
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""view"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../DataKlasifikasiProject/View';
                    LoadPartialViewData(UrlPartialView, function (data) {
                        $('#DivContentBody').hide();
                        document.getElementById(""DivFormBody"").innerHTML = data;
    ...
    function ValidationForm() {
        ");
            WriteLiteral(@"//Untuk validasi form
        ...
        $('#BtnSubmit').click(function () {
            ...
            if (!$valid) {
                ...
                if (State == ""edit"") {
                    url = '../DataKlasifikasiProject/SubmitEdit';
 ");
            WriteLiteral(@"               }
                else {
                    url = '../DataKlasifikasiProject/SubmitCreate';
                }
    ...
    function Delete(Id) {
        ...
        State = ""delete"";
           swal({
            ...
            WriteLiteral(@"enghapus data ini?"",
                icon: ""warning"",
                buttons: true,
                dangerMode: true,
            })
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '../DataKlasifikasiProject/Delete',
                            type: 'POST',
                            data: { ""Ids"": Id },
                            success: function (d) {
                                if (d == """") {
