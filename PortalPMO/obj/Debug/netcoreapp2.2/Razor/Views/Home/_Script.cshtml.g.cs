#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\Home\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1f506cd36acf96218480477196e05a56fa43618d"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Home__Script), @"mvc.1.0.view", @"/Views/Home/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Home/_Script.cshtml", typeof(AspNetCore.Views_Home__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1f506cd36acf96218480477196e05a56fa43618d", @"/Views/Home/_Script.cshtml")]
    ...
    public class Views_Home__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
#line 6 "C:\work\E-Library\E-Library\PortalPMO\Views\Home\_Script.cshtml"
...
#line 7 "C:\work\E-Library\E-Library\PortalPMO\Views\Home\_Script.cshtml"
                          Write(Html.Raw(ViewBag.TextDropdwonDefault));

#line default
#line hidden
            EndContext();
            BeginContext(288, 21344, true);
            WriteLiteral(@"';
    var TableSolicite;
    var TableProspek;
    var TablePipeline;
    ...
    function ClearSearchParameter() {
        ...
        $('#PegawaiIdSearchParam').append('<option value=""' + IdDropdwonDefault + '"" selected>' + TextDrop");
            WriteLiteral(@"dwonDefault + '</option>');
                ...
                if (hasil == true) {
                    $.ajax({
                        ...
                        success: function (d) {
                            ...
                            var TotalProspek = d.tblProspek[");
            WriteLiteral(@"0].Total_Prospek;
                            ...
                            var MaksimumKreditPipeline = d.tblPipeline[0].MaksimumKredit;
                            ...
                            $('#BerandaMaksimumKreditProspek').text(MaksimumKr");
            WriteLiteral(@"editProspek);
...
");
            WriteLiteral(@"                                    title: {
                                    ...
                                    data: [{
                                        ...
                                        dataPoints: [
                                            ...
                                            { y: TotalProspek, prosentase: ((TotalProspe");
            WriteLiteral(@"k) / (TotalSolicite + TotalProspek + TotalPipeline) * 100).toFixed(1), name: ""Prospek"", exploded: true },
    ...
    function explodePie(e) {
        if (typeof (");
            WriteLiteral(@"e.dataSeries.dataPoints[e.dataPointIndex].exploded) === ""undefined"" || !e.dataSeries.dataPoints[e.dataPointIndex].exploded) {
    ...
    function LoadTableUpcomingProject()
    {
        ...
        TableUpcomingProject = $('#TableUpcomingProject').DataTable({
                                ...
                                ""scrollCollapse"": true,
                                responsive: true,
                                processing: true, // untuk men");
            WriteLiteral(@"ampilkan bar prosessing
                                ...
                                ajax: {
                                    ...
                                    error: function (jqXHR, textStatus, errorThrown) {
                                        wind");
            WriteLiteral(@"ow.location.href = ""../Error/HttpStatusErrorLayout?statusCode=500""
                                    }
                                },
                                destroy: true,
                                ...
                                language: {
                                    ...
                                    in");
            WriteLiteral(@"foEmpty: ""Menampilkan 0 Sampai 0 Dari 0 Data"",
    ...
    function LoadTableOverdueProject()
    {
        ...
        TableOverdueProject = $('#TableOverdueProject').DataTable({
            ...
            ajax: {
                ""url"": '../Home/Lo");
            WriteLiteral(@"adDataProjectByTimeline',
                ""type"": ""POST"",
                ""datatype"": ""json"",
            ...
            columns: [
                ...
                { responsivePriority: 7, ""data"": ""ProjectNo"", ""name"": ""ProjectNo"" },
                { responsivePriority: 3, ""data"": ""NamaProject"", ""name"": ""NamaProject"" },
                { responsivePriority: 8, ""data"": ""Ta");
            WriteLiteral(@"nggalProject"", ""name"": ""TanggalProject"" },
                { responsivePriority: 7, ""data"": ""TimelinePengerjaan"", ""name"": ""TimelinePengerjaan"" },
                {
                    responsivePriority: 4, ""data"": ""Selisih"", ""name"": ""Selisih""
                },
        ...
        var fm = new FluidMeter();
                fm.init({
                  ...
                  options: {
                    ...
                    borderWidth: 19,
 ");
            WriteLiteral(@"                   backgroundColor: ""#e2e2e2"",
    ...
    ");
            ...
            WriteLiteral(@" '<div class=""widget-content-wrapper"">' +
                                        ...
                                        '<a href=""javascript:void(0)"" class=""badge badge-pill badge-success pull-right"" style=""margin-right:10px !important;"" onclick=""DetailProject(' + value.ProjectId+')"">Detai");
            WriteLiteral(@"l Project</a' +
                                        '</div>' +
                                        '</div>' +
                                        '</div>' +
                                        '</div>' +
    ...
    function ViewFasilitas(Id) {
        ...
        UrlPartialView = '");
            EndContext();
            BeginContext(21633, 41, false);
#line 404 "C:\work\E-Library\E-Library\PortalPMO\Views\Home\_Script.cshtml"
                     Write(Url.Content("~/Home/ViewFasilitasKredit"));

#line default
#line hidden
            EndContext();
            BeginContext(21674, 40912, true);
            WriteLiteral(@"';
...
");
 ...
 ");
                ...
                { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                {
                    ...
                    ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                        //return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                            //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-view"" onclick=""ViewFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Data""><i class=""fa fa-e");
            WriteLiteral(@"ye btnView""></i></a>'
    ...
    function LoadDataTableProspek(data) {
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    TableProspek = $('#TableProspek').DataTable({
                        ...
                        processing: true, // untuk menampilkan bar prosessing
                        serverSide: true, // untuk proses server side datatable harus diset true
                        orderMulti: false, // untuk disable multi orde");
            WriteLiteral(@"r column
                        retrieve: true,
                        //autoWidth: true,
                        dom: '<""top""i>rt<""bottom""lp><""clear"">', // untuk menghilangkan search global
                        //data: data,
            ...
            WriteLiteral(@" Data"",
                        ...
                        columns: [
                            { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                            {
                                ...
                                ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                    //re");
            WriteLiteral(@"turn '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
            ...
            WriteLiteral(@" }
                    ...
                    //    TableProspek.columns(2).");
            WriteLiteral(@"search($('#txtKodeSearchParam').val().trim());
                    ...
                    window.location.h");
            WriteLiteral(@"ref = ""../Login/Login?a=true"";
                }
            }
        });
    }
    function LoadDataTablePipeline(data) {
        ...
        $.ajax({
            ...
            WriteLiteral(@"group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                                    //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-view"" onclick=""ViewFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Data""><i class=""fa fa-eye btnView""></i></a>'
                                    //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-delete"" onclick=""DeleteFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Delete Data""><i class=""fa fa-trash btnDelete""></i></a></div>'
            ...
            WriteLiteral(@"          },
                    ...
                    //oTable = $('#Table').DataTable();
                    //$('#BtnSearch').click(function () {
                    //    TablePipeline.columns(2).search($('#txtKodeSea");
            WriteLiteral(@"rchParam').val().trim());
    ...
    //                    serverSide: true, // untuk proses server side datatable harus diset true
    //                    orderMulti: false, // un");
            WriteLiteral(@"tuk disable multi order column
    //                    retrieve: true,
    //                    //autoWidth: true,
    //                    dom: '<""top""i>rt<""bottom""lp><""clear"">', // untuk menghilangkan search global
    //                    //data: data,
    ...
    //                        processing: '<i class=""fa fa-spinner fa-spin fa-3x fa-fw""></i><span class=""sr-only"">Loading...</span> ',
    //                        info: ""Menampil");
            WriteLiteral(@"kan _START_ Sampai _END_ Dari _TOTAL_ Data"",
    //                        paginate: {
    //                            first: ""Halaman Awal"",
    //                            last: ""Halaman Akhir"",
    //                            previous: ""Halaman Sebelumnya"",
    ...
    //                        {
    //                            responsivePriority: 2,
    //                            ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function");
            WriteLiteral(@" (data, type, full, meta) {
    //                                //return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
    //                                //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-view"" onclick=""ViewFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Data""><i class=""fa fa-eye btnView""></i></a>'
    //                                //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-delete"" onclick=""DeleteFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Delete Data""><i class=""fa fa-trash btnDelete""></i></a></div>'

    //                                return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-view"" onclick=""ViewFasilitas(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Da");
            WriteLiteral(@"ta""><i class=""fa fa-eye btnView""></i></a>'
    ...
    //                //oTable = $('#Table').DataTable();
    ");
            WriteLiteral(@"//                //$('#BtnSearch').click(function () {
    ...
    //     ");
            WriteLiteral(@"           TableSolicite.columns.adjust().responsive.recalc();
    //            }
    //            else {
    //                window.location.href = ""../Login/Login?a=true"";
    //            }
    ...
    //                    orderCellsTop: true,
    //                    responsive: true,
    //                    processing: true, // untuk menampilkan ");
            WriteLiteral(@"bar prosessing
    //                    serverSide: true, // untuk proses server side datatable harus diset true
    //                    orderMulti: false, // untuk disable multi order column
    //                    retrieve: true,
    //                    //autoWidth: true,
    ...
    //                                return '<div class=""btn-g");
            WriteLiteral(@"roup""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-view"" onclick=""ViewFasilitas(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Data""><i class=""fa fa-eye btnView""></i></a>'
    ...
    //                //--------------------------Function untuk melemp");
            WriteLiteral(@"ar parameter search ---------------------//
    //                //Untuk melempar parameter search
    //                //oTable = $('#Table').DataTable();
    //                //$('#BtnSearch').click(function () {
    //                //    TableProspek.columns(2).search($('#txtKodeSearchParam').val().trim());
    ...
    //                    TableProspek.columns(2).search($('#txtKodeSearchParam').val().trim());
    //                    TableProspek.columns(3).search($('#txtNamaSearchPar");
            WriteLiteral(@"am').val().trim());
    //                    //hit search ke server
    //                    TableProspek.draw();
    //                });
    ...
    //                                //return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
    //                                //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-view"" onclick=""ViewFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Data""><i class=""fa fa-eye btnView""></i></a>'
    //                                //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-delete"" onclick=""DeleteFAQ(' + full.Id ");
            WriteLiteral(@"+ ')""  data-toggle=""tooltip"" title=""Delete Data""><i class=""fa fa-trash btnDelete""></i></a></div>'
 ...
 ");
    ...
    //  ");
            WriteLiteral(@"                  TablePipeline.columns(2).search($('#txtKodeSearchParam').val().trim());
    //                    TablePipeline.columns(3).search($('#txtNamaSearchParam').val().trim());
    //                    //hit search ke server
    //                    TablePipeline.draw();
    //                });
          ...
          ");
            ...
            WriteLiteral(@"-------------Function untuk melempar parameter search ---------------------//
                    ...
                    $('#BtnClearSearch').click(function () {
                        ...
                        TableFasilitasKredit.columns(2).search($('#txtKodeSearchParam').val().trim());
                        TableFasilitasKredit.colu");
            WriteLiteral(@"mns(3).search($('#txtNamaSearchParam').val().trim());
                        //hit search ke server
                        TableFasilitasKredit.draw();
                    });
