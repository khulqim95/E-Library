#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\DataSubKategoriProject\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a0a72e70c9aa9a5e08e29a4b47df5e67546ea1e8"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_DataSubKategoriProject__Script), @"mvc.1.0.view", @"/Views/DataSubKategoriProject/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/DataSubKategoriProject/_Script.cshtml", typeof(AspNetCore.Views_DataSubKategoriProject__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a0a72e70c9aa9a5e08e29a4b47df5e67546ea1e8", @"/Views/DataSubKategoriProject/_Script.cshtml")]
    ...
    public class Views_DataSubKategoriProject__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
  ...
  ");
            WriteLiteral(@"                      retrieve: true,
                        ...
                        //data: data,
                        ajax: {
                            ""url"": '../DataSubKategoriProject/LoadData',
                            ""type"": ""POST"",
                            ""datatype"": ""json"",
    ...
    function Create() {
        ...
        State = ""create"";
        UrlPartialView = '../DataSubKategoriProject/Create';
    ...
    function Edit(Id) {
        ...
        $.ajax({
            ...
            WriteLiteral(@"= true) {
                    ...
                    State = ""edit"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../DataSubKategoriProject/Edit';
                    LoadPartialViewData(UrlPartialView, function (data) {
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""view"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../DataSubKategoriProject/View';
                    LoadPartialViewData(UrlPartialView, function (data) {
                        $('#DivContentBody').hide();
                        document.getElementById(""DivFormBody"").innerHTML = data;
    ...
    function ValidationForm() {
        ...
        $('#BtnSubmit').click(function () {
            ...
            if (!$valid) {
                ...
                if (State == ""edit"") {
                    url = '../DataSubKategoriProject/SubmitEdit';
 ");
            WriteLiteral(@"               }
                else {
                    url = '../DataSubKategoriProject/SubmitCreate';
                }
           ...
           swal({
            ...
            WriteLiteral(@"enghapus data ini?"",
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '../DataSubKategoriProject/Delete',
                            type: 'POST',
                            data: { ""Ids"": Id },
                            success: function (d) {
                                if (d == """") {
