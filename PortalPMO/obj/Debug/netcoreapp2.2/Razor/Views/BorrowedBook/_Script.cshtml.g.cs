#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\BorrowedBook\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f3061b16c6d45d088b2c01b6dfccf096138e926f"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f3061b16c6d45d088b2c01b6dfccf096138e926f", @"/Views/BorrowedBook/_Script.cshtml")]
    ...
    function LoadDataTable(data) {
        ...
        $.ajax({
            ...
            WriteLiteral(@"""Name"", ""name"": ""Name"" },
                            ...
                            { responsivePriority: 7, ""data"": ""BorrowDate"", ""name"": ""BorrowDate"", ""orderable"": false, ""className"": ""text-center""},
                            { responsivePriority: 7, ""data"": ""FinishDate"", ""name"": ""FinishDate"", ""orderable"": false, ""className"": ""text-center"" },
                            {
            ...
            WriteLiteral(@"            },
                            ...
                            {
                                responsivePr");
            WriteLiteral(@"iority: 11, ""data"": ""IsLate"", ""name"": ""IsLate"", ""className"": ""text-center"",
                                ""render"": function (data, type, full, meta) {
                                    debugger;
                                    if (data == true) {
                                        return '<center><p class=""mt-2 btn btn-block btn-primary disabled""><b> Yes </b></p></center>'
                    ...
                    //Untuk ");
            WriteLiteral(@"melempar parameter search
    ...
    function Create() {
        ...
        $.ajax({
            ...
            WriteLiteral(@" = ""../Login/Login?a=true"";
                }
            }
        });
    }
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    LoadPartialViewData(UrlPartialView, function (data) {
                        ...
                        //var mm = today.getMonth() + 1; //January is 0 so ne");
            WriteLiteral(@"ed to add 1 to make it 1!
    ...
    function inputGroupFileBook() {
        ...
        if ($('#InputDokumenBook').val() != '' && $('#InputDokumenBook').val() != 'Choose file') {
            ...
            if (filename.ends");
            WriteLiteral(@"With('.PNG') || filename.endsWith('.JPG') || filename.endsWith('.jpg') || filename.endsWith('.png')) {
                $('#warning').hide();
                error = false;
            } else {
