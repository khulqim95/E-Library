#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\DataMasterClient\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dd5f2fe92f6850d5e8aea8fd4e2ddc3285dd87d5"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_DataMasterClient__Script), @"mvc.1.0.view", @"/Views/DataMasterClient/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/DataMasterClient/_Script.cshtml", typeof(AspNetCore.Views_DataMasterClient__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dd5f2fe92f6850d5e8aea8fd4e2ddc3285dd87d5", @"/Views/DataMasterClient/_Script.cshtml")]
    ...
    public class Views_DataMasterClient__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 15726, true);
  ...
  ");
     ...
     ");
            ...
            WriteLiteral(@"lick=""Edit(' + full.Id + ')"" style=""margin-right:5px;"" data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                            ...
                            { responsivePriority: 3, ""data"": ""TypeClient"", ""name"": ""TypeClient"" },
                            { responsivePriority: 3, ""data"": ""Kode"", ""name"": ""Kode"" },
                            { responsivePriority: 4, ""data"": ""Nama"", ""name"": ""Nama"" },
     ");
            WriteLiteral(@"                       { responsivePriority: 5, ""data"": ""Keterangan"", ""name"": ""Keterangan"" },
                            { responsivePriority: 6, ""data"": ""Order_By"", ""name"": ""Order_By"", ""visible"": false },
                            {
               ...
               ");
            WriteLiteral(@"             { responsivePriority: 9, ""data"": ""CreatedBy"", ""name"": ""CreatedBy"", ""visible"": false },
    ...
    function Create() {
        ...
        State = ""create"";
        UrlPartialView = '../DataMasterClient/Create';
     ");
            WriteLiteral(@"   //Cek session masih aktif atau tidak
        $.ajax({
            type: 'GET',
            url: '../Login/CekSession',
            success: function (hasil) {
                if (hasil == true) {
                    LoadPartialViewData(UrlPartialView, function (data) {
                        ...
                        DropdownTypeClietnServerSide('TypeClientId', 100, false);
                    });
                }
                else {
                    window.location.href = ""../Login/Login?a=true"";
    ...
    function Edit(Id) {
        Sho");
            WriteLiteral(@"wModal('bd-example-modal-lg');
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""edit"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../DataMasterClient/Edit';
                    LoadPartialViewData(UrlPartialView, function (data) {
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""view"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../DataMasterClient/View';
                    LoadPartialViewData(UrlPartialView, function (data) {
                        $('#DivContentBody').hide();
                        document.getElementById(""DivFormBody"").innerHTML = data;
                    ...
                    window.location.href = ""../Login/Logi");
            WriteLiteral(@"n?a=true"";
                }
            }
        });
    }
    ...
    function ValidationForm() {
        ...
        var $validator = $(""#FormData"").validate({
            ...
            WriteLiteral(@"-group').removeClass('has-error').addClass('has-success');
            },
            errorElement: 'span',
   ...
   ");
            ...
            if (!$valid) {
                ...
                if (State == ""edit"") {
                    url = '../DataMasterClient/SubmitEdit';
                }
                else {
                    url = '../DataMasterClient/SubmitCreate';
                }
                        ...
                        $.ajax({
                            ...
                            success: function (d) {
                                if (d == """") {
                                    ...
                                    NotifikasiErro");
            WriteLiteral(@"r(""Error"", ""Data gagal dihapus!"")
                                }
                                Table.draw();
                            }
                        });
