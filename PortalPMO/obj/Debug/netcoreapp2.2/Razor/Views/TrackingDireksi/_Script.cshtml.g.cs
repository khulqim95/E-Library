#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingDireksi\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4ede8b2e55cc7c08d2dabc879eb249635240fe8d"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_TrackingDireksi__Script), @"mvc.1.0.view", @"/Views/TrackingDireksi/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/TrackingDireksi/_Script.cshtml", typeof(AspNetCore.Views_TrackingDireksi__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4ede8b2e55cc7c08d2dabc879eb249635240fe8d", @"/Views/TrackingDireksi/_Script.cshtml")]
    ...
    public class Views_TrackingDireksi__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
#line 6 "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingDireksi\_Script.cshtml"
...
#line 7 "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingDireksi\_Script.cshtml"
                          Write(Html.Raw(ViewBag.TextDropdwonDefault));

#line default
#line hidden
            EndContext();
            BeginContext(288, 23113, true);
            WriteLiteral(@"';
    var TableSolicite;
    var TableProspek;
    var TablePipeline;
    ...
    $(document).ready(function () {
        ...
        DropdownDataSegmenServerSide(""Segmen"", ""100"", false);
  ...
  ");
            WriteLiteral(@"      $('.clickParent2').css(""background-color"", ""#00bfbf"");
        $('.clickParent3').css(""background-color"", ""white"");
        ChangeState();
    }
    ...
    function ChangeState() {
        if (StateParent == 1 && DataDashboard == 1) {
            ...
            $('#tableS");
            WriteLiteral(@"olicite').css(""display"", ""none"");
            $('#tableProspek').css(""display"", ""none"");
            ...
            success: function (hasil) {
                if (hasil == true) {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: { ""UnitId"": $(""#SRMandRMId"").val(), ""UserId"": $(""#RMId"").val() },
                        success: function (d) {
                            debugger");
            WriteLiteral(@";
                            console.log(d)
                            var unitid = $(""#SRMandRMId"").val();
                            var userid = $(""#RMId"").val();
                            ...
                            var TotalDebiturUsulan = 0;
                            var TotalDebiturDisetujui = 0;
                            var TotalGapDebitur = 0;
                            var TotalMaksimumKreditUsulan = 0;
                            var TotalMaksimumKreditDisetujui = 0;
                            var TotalGapMaksimumKredit = 0;

                            //Beranda Top
                            $('#BerandaTotalDebiturUsulan').text(TotalDebiturUsulan);
                   ");
            WriteLiteral(@"         $('#BerandaTotalMaksimumKreditUsulan').text(TotalMaksimumKreditUsulan);
  ...
  ");
    ...
    function LoadTableUpcomingProject()
    {
        ...
        TableUpcomingProject = $('#TableUpcomingProject').DataTable({
            ...
            WriteLiteral(@"                    dom: '<""top""i>rt<""bottom""lp><""clear"">', // untuk menghilangkan search global
                                ...
                                language: {
                                    processing: '<i class=""fa fa-spinner fa-spin fa-3x f");
            WriteLiteral(@"a-fw""></i><span class=""sr-only"">Loading...</span> ',
            ...
            WriteLiteral(@"           {
                                    ...
                                    { responsivePriority: 7, ""data"": ""TimelinePengerjaan"", ""name");
            WriteLiteral(@""": ""TimelinePengerjaan"" },
                                    {
    ...
    function LoadTableOverdueProject()
    {
        ...
        TableOverdueProject = $('#Ta");
            WriteLiteral(@"bleOverdueProject').DataTable({
            fixedHeader: {
                header: true
            },
            pageLength: 10,
                            ...
                            if (d != null) {
                                ...
                                $.each(d, function (index, value) {
                                    $('#ListProgressTaskList').append('<li class=""list-group-item"">' +
                                        ...
                                        '<span style=""font-size:8px; font-weight:bold"">' + value.TimelinePengerjaan + ' (' + value");
            WriteLiteral(@".Selisih+' hari)</span><br />' +
    ...
    function ViewFasilitas(Id, Flagging) {
        ...
        UrlPartialView = '");
            EndContext();
            BeginContext(23402, 52, false);
#line 460 "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingDireksi\_Script.cshtml"
                     Write(Url.Content("~/TrackingWilayah/ViewFasilitasKredit"));

#line default
#line hidden
            EndContext();
            BeginContext(23454, 21274, true);
            WriteLiteral(@"';
                ...
                { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                {
                    ...
                    ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                        //return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                            //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-view"" onclick=""ViewFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Data""><i class=""fa fa");
            WriteLiteral(@"-eye btnView""></i></a>'
            ...
            success: function (hasil) {
                if (hasil == true) {
                    TableProspek = $('#TableProspek').DataTable({
                        ...
                        retrieve: true,
                        //autoWidth: true,
                        dom: '<""top""i>rt<""bottom""lp><""clear"">', // untuk ");
            WriteLiteral(@"menghilangkan search global
                        //data: data,
                        ajax: {
            ...
            WriteLiteral(@""",
                        ...
                        columns: [
                            { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                            {
                                responsivePriority: 2,
                                ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                    //return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=");
            WriteLiteral(@"""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                            ...
                            { responsivePriority: 3, ""data"": ""NamaPegawai"", ""name"": ""NamaPegawai"" },
                    ");
            WriteLiteral(@"        { responsivePriority: 4, ""data"": ""Npp"", ""name"": ""Npp"" },
                            { responsivePriority: 5, ""data"": ""MaksimumKredit"", ""name"": ""MaksimumKredit"" }
                        ],
                        ""order"": [[1, ""desc""]]
                    });
                    ...
                    //---------------------Function untuk reset data pe");
            WriteLiteral(@"ncarian----------------//
        ...
        $.ajax({
            ...
            WriteLiteral(@"type"": ""POST"",
                        ...
                        language: {
                            ...
                            lengthMenu: """);
            WriteLiteral(@"Menampilkan _MENU_ Data"",
                            emptyTable: ""Data tidak ditemukan"",
                            infoEmpty: ""Menampilkan 0 Sampai 0 Dari 0 Data"",
                            zeroRecords: ""Data tidak ditemukan""
                        },
                        columns: [
                            { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                            {
                                ...
                                ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                    //return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                                    //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-view"" onclick=""View");
            WriteLiteral(@"FAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Data""><i class=""fa fa-eye btnView""></i></a>'
                                    //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-delete"" onclick=""DeleteFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Delete Data""><i class=""fa fa-trash btnDelete""></i></a></div>'
    ...
    function LoadDataTableFasilitasKredit(data) {
        ...
        $.ajax({
            ...
            WriteLiteral(@"Search').click(function () {
                    ...
                    TableFasilitas");
            WriteLiteral(@"Kredit.columns.adjust().responsive.recalc();
                }
                else {
                    window.location.href = ""../Login/Login?a=true"";
                }
