#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingWilayah\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cc3a1fa506b83be1e1a4f7f8bed7b9d7b5d71f95"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_TrackingWilayah__Script), @"mvc.1.0.view", @"/Views/TrackingWilayah/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/TrackingWilayah/_Script.cshtml", typeof(AspNetCore.Views_TrackingWilayah__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cc3a1fa506b83be1e1a4f7f8bed7b9d7b5d71f95", @"/Views/TrackingWilayah/_Script.cshtml")]
    ...
    public class Views_TrackingWilayah__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
#line 6 "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingWilayah\_Script.cshtml"
...
#line 7 "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingWilayah\_Script.cshtml"
                          Write(Html.Raw(ViewBag.TextDropdwonDefault));

#line default
#line hidden
            EndContext();
            BeginContext(288, 23400, true);
            WriteLiteral(@"';
    var TableSolicite;
    var TableProspek;
    var TablePipeline;
    ...
    function LoadDataBeranda() {
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    $.ajax({
                        url: ""../TrackingWilayah/GetAllDataPendingTask"",
                        type: 'POST',
                        data: { ""UnitId"": $(""#WilayahId"").val(), ""UserId"": $(""#RMId"")");
            WriteLiteral(@".val() },
                        success: function (d) {
                            debugger;
                            console.log(d)
                            var unitid = $(""#WilayahId"").val();
                            var userid = $(""#RMId"").val();
                            ...
                            var TotalMaksimumKr");
            WriteLiteral(@"editDisetujui = d.ExecutiveSummary[0].MaksimumKreditSetujui;
                            ...
                            $('#BerandaTotalPipeline').te");
            WriteLiteral(@"xt(TotalPipeline);
            ...
            WriteLiteral(@"es"",
                                    ...
                                    data: [{
                                        ...
                                        dataPoints: [
                                            ...
                                            { y: TotalProspek, prosentase: ((Total");
            WriteLiteral(@"Prospek) / (TotalSolicite + TotalProspek + TotalPipeline) * 100).toFixed(1), name: ""Prospek"", exploded: true },
    ...
    function explodePie(e) {
        if (typeof (e.dataSeries.dataPoints[e.");
            WriteLiteral(@"dataPointIndex].exploded) === ""undefined"" || !e.dataSeries.dataPoints[e.dataPointIndex].exploded) {
 ...
 ");
            ...
            WriteLiteral(@"../Error/HttpStatusErrorLayout?statusCode=500""
                                ...
                                language: {
                                    ...
                                    infoEmpty: ""Menampilka");
            WriteLiteral(@"n 0 Sampai 0 Dari 0 Data"",
    ...
    function LoadTableOverdueProject()
    {
        ...
        TableOverdueProject = $('#TableOverdueProject').DataTable({
            ...
            dom: '<""top""i>rt<""bottom""lp><""clear"">', // untuk menghilangkan search global
            ajax: {
                ""url"": '../Home/LoadDataProjectByTimel");
            WriteLiteral(@"ine',
                ""type"": ""POST"",
                ""datatype"": ""json"",
   ...
   ");
            ...
            columns: [
                ...
                { responsivePriority: 8, ""data"": ""TanggalProject"", ""name");
            WriteLiteral(@""": ""TanggalProject"" },
                { responsivePriority: 7, ""data"": ""TimelinePengerjaan"", ""name"": ""TimelinePengerjaan"" },
                {
                    responsivePriority: 4, ""data"": ""Selisih"", ""name"": ""Selisih""
                },
        ...
        var fm = new FluidMeter();
                fm.init({
                  ...
                  options: {
                    ...
                    borderWidth: 19,
                    b");
            WriteLiteral(@"ackgroundColor: ""#e2e2e2"",
   ...
   ");
    ...
    function ViewFasilitas(Id, Flagging) {
        ...
        UrlPartialView = '");
            EndContext();
            BeginContext(23689, 52, false);
#line 455 "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingWilayah\_Script.cshtml"
                     Write(Url.Content("~/TrackingWilayah/ViewFasilitasKredit"));

#line default
#line hidden
            EndContext();
            BeginContext(23741, 19680, true);
            WriteLiteral(@"';
    ...
    function LoadDataTableSolicite(data) {
        ...
        TableSolicite = $('#TableSolicite').DataTable({
            ...
            //data: data,
            ajax: {
                ""url"": '../TrackingWilayah/LoadDataTableSolicite',
                ""type"": ""POST"",
                ""datatype"": ""json"",
                ""data"": { ""UnitId"": $('#WilayahId').val(), ""UserId"": $('#RMId').val() },
                error: function (jqXHR, textStatus, errorThrown) {
                    window.location.href = ""../Error/HttpStatusErrorLayout?statusCode=500""
                }
            },
                ...
                { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                {
                    ...
                    ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                        //return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                            //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-view"" onclick=""ViewFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Data""><");
            WriteLiteral(@"i class=""fa fa-eye btnView""></i></a>'
    ...
    function LoadDataTablePros");
            WriteLiteral(@"pek(data) {
        debugger;
            ...
            success: function (hasil) {
                if (hasil == true) {
                    TableProspek = $('#TableProspek').DataTable({
                        ...
                        //autoWidth: true,
                        dom: '<""top""i>rt<""bottom""");
            WriteLiteral(@"lp><""clear"">', // untuk menghilangkan search global
                        //data: data,
                        ajax: {
                            ""url"": '../TrackingWilayah/LoadDataTableProspek',
                            ""type"": ""POST"",
                            ""datatype"": ""json"",
                            ""data"": { ""UnitId"": $('#WilayahId').val(), ""UserId"": $('#RMId').val() },
                            error: function (jqXHR, textStatus, errorThrown) {
            ...
            WriteLiteral(@"        last: ""Halaman Akhir"",
                        ...
                        columns: [
                            { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                            {
                                responsivePriority: 2,
                                ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                    //return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' +");
            WriteLiteral(@" full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                            ...
                            { responsivePriority: 3, ""data"": ""NamaPegawai"", ""name"": ");
            WriteLiteral(@"""NamaPegawai"" },
                            { responsivePriority: 4, ""data"": ""Npp"", ""name"": ""Npp"" },
                            { responsivePriority: 5, ""data"": ""MaksimumKredit"", ""name"": ""MaksimumKredit"" }
                        ],
                        ""order"": [[1, ""desc""]]
            ...
            success: function (hasil) {
                if (hasil == true) {
                    TablePipeline = $('#TablePipeline').DataTable({
                        ...
                        //data: data,
                        ajax: {
                            ""url"": '../TrackingWilayah/LoadDataTab");
            WriteLiteral(@"lePipeline',
                            ""type"": ""POST"",
                            ""datatype"": ""json"",
                            ""data"": { ""UnitId"": $('#WilayahId').val(), ""UserId"": $('#RMId').val() },
                            error: function (jqXHR, textStatus, errorThrown) {
            ...
            WriteLiteral(@"
                        ...
                        columns: [
                            { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                            {
                                ...
                                ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                    //return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                                    //+ '<a href=""javascript:void(0)"" class=""btn btn-small bt");
            WriteLiteral(@"n-facebook"" id=""button-view"" onclick=""ViewFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Data""><i class=""fa fa-eye btnView""></i></a>'
                                    //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-delete"" onclick=""DeleteFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Delete Data""><i class=""fa fa-trash btnDelete""></i></a></div>'
                            ...
                            { responsivePriority: 3, ""data"": ""NamaPegawai"", ""name"": ""NamaPegawai"" },
                            { responsivePriority: 4, ""data"": ""Npp"", ""name"": ""Npp"" },
                            { responsivePriority: 5, ""data"": ""MaksimumKredit"", ""name"":");
 ...
 ");
    ...
    function LoadDataTableFasilitasKredit(Id, Flag) {
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    TableFasilitasKredit = $(");
            WriteLiteral(@"'#TableFasilitasKredit').DataTable({
                        fixedHeader: {
                            header: true
                        },
                        pageLength: 10,
                        ...
                        //data: data,
                        ajax: {
                            ""url"": '../TrackingWilayah/LoadDataTableFasilitasKredit',
                            ""type"": ""POST"",
                            ""datatype"": ""json"",
         ");
            WriteLiteral(@"                   ""data"": { ""Id"": Id, ""Flag"": Flag },
                            error: function (jqXHR, textStatus, errorThrown) {
                                window.location.href = ""../Error/HttpStatusErrorLayout?statusCode=500""
                            }
                        },
            ...
            WriteLiteral(@"        infoEmpty: ""Menampilkan 0 Sampai 0 Dari 0 Data"",
                    ...
                    TableFasilita");
            WriteLiteral("sKredit.columns.adjust().responsive.recalc();\r\n                }\r\n                else {\r\n                    window.location.href = \"../Login/Login?a=true\";\r\n                }\r\n            }\r\n        });\r\n    }\r\n\r\n</script>");
            EndContext();
        }
