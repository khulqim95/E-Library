#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingRM\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "62e8baa18ff347e4117b6bcd01742c5aaccc5d2b"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_TrackingRM__Script), @"mvc.1.0.view", @"/Views/TrackingRM/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/TrackingRM/_Script.cshtml", typeof(AspNetCore.Views_TrackingRM__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"62e8baa18ff347e4117b6bcd01742c5aaccc5d2b", @"/Views/TrackingRM/_Script.cshtml")]
    ...
    public class Views_TrackingRM__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
#line 6 "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingRM\_Script.cshtml"
...
#line 7 "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingRM\_Script.cshtml"
                          Write(Html.Raw(ViewBag.TextDropdwonDefault));

#line default
#line hidden
            EndContext();
            BeginContext(288, 22827, true);
            WriteLiteral(@"';
    var TableSolicite;
    var TableProspek;
    var TablePipeline;
    ...
    function Parent2() {
        ...
        $('.clickPa");
            WriteLiteral(@"rent2').css(""background-color"", ""#00bfbf"");
        $('.clickParent3').css(""background-color"", ""white"");
        ChangeState();
    }
    ...
    function ChangeState() {
        if (StateParent == 1 && DataDashboard == 1) {
            ...
            $('#tableSolicite').css(""display"", ""none"");
 ");
            WriteLiteral(@"           $('#tableProspek').css(""display"", ""none"");
    ...
    function LoadDataBeranda() {
        $.ajax({
            ...
            WriteLiteral(@"Id = userid;
                            ...
                            $('#BerandaTotalMaksimumKre");
            WriteLiteral(@"ditUsulan').text(TotalMaksimumKreditUsulan);
                                ...
                                columns: [
                                    { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                                    {
                                        ...
                                        ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                            return '<a h");
            WriteLiteral(@"ref=""javascript:void(0)"" class=""btn btn-facebook"" id=""button-edit"" onclick=""DetailProject(' + full.ProjectId + ')"" style=""margin-right:5px;"" data-toggle=""tooltip"" title=""Detail Project""><i class=""fa fa-edit btnEdit""></i></a>'
                                        }
                                    },
                                    ...
                                    {
                                       ");
            WriteLiteral(@" responsivePriority: 5, ""data"": ""StatusProject"", ""name"": ""StatusProject"",
    ...
    function LoadTableOverdueProject()
    {
        ...
        TableOverdueProject = $('#TableOverdueProject').DataTable({
            ...
            responsive: true,
            pro");
            WriteLiteral(@"cessing: true, // untuk menampilkan bar prosessing
            serverSide: true, // untuk proses server side datatable harus diset true
            orderMulti: false, // untuk disable multi order column
            retrieve: true,
            //autoWidth: true,
            ...
            columns: [
                { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                {
                    responsivePriority: 2,
                    ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                        return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""DetailProject(' ");
            WriteLiteral(@"+ full.ProjectId + ')"" style=""margin-right:5px;"" data-toggle=""tooltip"" title=""Detail Project""><i class=""fa fa-edit btnEdit""></i></a></div>'
                    }
                },
                { responsivePriority: 7, ""data"": ""ProjectNo"", ""name"": ""ProjectNo"" },
                { responsivePriority: 3, ""data"": ""NamaProject"", ""name"": ""NamaProject"" },
    ...
    function CreateProgressMeter(total)
    {
        ...
        ");
            WriteLiteral(@"var fm = new FluidMeter();
                fm.init({
                    ...
                    $.ajax({
                        ...
                        success: function (d) {
                            ...
                            if (d != null) {
                                ...
                                $('#Lis");
            WriteLiteral(@"tProgressTaskList').html("""");
                                $.each(d, function (index, value) {
                                    $('#ListProgressTaskList').append('<li class=""list-group-item"">' +
                                        ...
                                        '</div>' +
                ");
            WriteLiteral(@"                        '<div class=""widget-subheading"" style=""margin-top:-15px;""><i>' + value.DetailRequirment+'</i></div>' +
    ...
    function ViewFasilitas(Id, Flagging) {
        ...
        UrlPartialView = '");
            EndContext();
            BeginContext(23116, 52, false);
#line 448 "C:\work\E-Library\E-Library\PortalPMO\Views\TrackingRM\_Script.cshtml"
                     Write(Url.Content("~/TrackingWilayah/ViewFasilitasKredit"));

#line default
#line hidden
            EndContext();
            BeginContext(23168, 18045, true);
            WriteLiteral(@"';
    ...
    function LoadDataTableSolicite(data) {
        ...
        TableSolicite = $('#TableSolicite').DataTable({
            ...
            ");
            WriteLiteral(@"                //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-delete"" onclick=""DeleteFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Delete Data""><i class=""fa fa-trash btnDelete""></i></a></div>'
                        ...
                        columns: [
                            { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                            {
                                ...
                                ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                    //return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-edit"" onclick=""EditFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
      ");
            WriteLiteral(@"                              //+ '<a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-view"" onclick=""ViewFAQ(' + full.Id + ')""  data-toggle=""tooltip"" title=""View Data""><i class=""fa fa-eye btnView""></i></a>'
        ...
        $.ajax({
            ...
            WriteLiteral(@"                  first: ""Halaman Awal"",
                        ...
                        columns: [
                           ...
                           ");
            WriteLiteral(@" { responsivePriority: 5, ""data"": ""Tujuan"", ""name"": ""Tujuan"" },
