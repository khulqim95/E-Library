#pragma checksum "C:\work\Portal PMO\PortalPMO\Views\BookShelf\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "02437c52ed2fb21ad242afec92301f452e8aaf68"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"02437c52ed2fb21ad242afec92301f452e8aaf68", @"/Views/BookShelf/_Script.cshtml")]
            ...
            WriteLiteral(@"nction (data, type, full, meta) {
                            ...
                            },
                            {
                                ...
                                ""render"": function (data, type, full, meta) {
                                    debugger;
                                    if (data == true) {
                                        return '<center><p class=""mt-2 btn btn-block ");
            WriteLiteral(@"btn-primary disabled""><b> Yes </b></p></center>'
                                    }
                                    else {
                                        return '<center><p class=""mt-2 btn btn-block btn-danger disabled""><b> No </b></p></center>'
                                    }
    ...
    function Create() {
        ...
        //Cek session masih aktif atau tid");
            WriteLiteral(@"ak
        $.ajax({
            type: 'GET',
            url: '../Login/CekSession',
 ...
 ");
    ...
    function inputGroupFileBook() {
       ...
       ");
            WriteLiteral(@"         $('#error-file-text').text('File bukan PNG/JPG.');
                $('#warning').show();
                error = true;
            }
