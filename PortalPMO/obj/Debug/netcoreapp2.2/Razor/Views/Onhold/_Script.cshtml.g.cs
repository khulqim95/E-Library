#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\Onhold\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "86b814c210f87a10b05a921dc5f5d31d56a25604"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Onhold__Script), @"mvc.1.0.view", @"/Views/Onhold/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Onhold/_Script.cshtml", typeof(AspNetCore.Views_Onhold__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"86b814c210f87a10b05a921dc5f5d31d56a25604", @"/Views/Onhold/_Script.cshtml")]
    ...
    public class Views_Onhold__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 5881, true);
        ...
        $.ajax({
            ...
            WriteLiteral(@"Side: true, // untuk proses server side datatable harus diset true
                        ...
                        language: {
                            ...
                            info: ""Menampilkan _STA");
            WriteLiteral(@"RT_ Sampai _END_ Dari _TOTAL_ Data"",
                            paginate: {
                                first: ""Halaman Awal"",
                                last: ""Halaman Akhir"",
           ...
           ");
            WriteLiteral(@"                         /********************************************************************************************************************************************************************************************************************************************************************************************************************************/
                            ...
                            { responsivePrior");
            WriteLiteral(@"ity: 5, ""data"": ""NamaDebitur"", ""name"": ""NamaDebitur"" },
...
");
        ...
        $.ajax({
            ...
            WriteLiteral(@"ta,
                        ajax: {
                            ""url"": '../Onhold/LoadDataTableFasilitasKredit',
                            ""type"": ""POST"",
                            ""datatype"": ""json"",
                            ""data"": { ""Id"": data },
                            error: function (jqXHR, textStatus, errorThrown) {
                        ...
                        language: {
                            ...
                            paginate: {
                                ...
                                previous: ""Halaman Sebelumnya"",
                                next: ""H");
            WriteLiteral(@"alaman Selanjutnya"",
                            },
                            lengthMenu: ""Menampilkan _MENU_ Data"",
                            emptyTable: ""Data tidak ditemukan"",
                            infoEmpty: ""Menampilkan 0 Sampai 0 Dari 0 Data"",
          ...
          ");
            ...
            WriteLiteral(@"                 }
                            ...
                            },
                            {
                                ...
                                ""render"": f");
            WriteLiteral(@"unction (data, type, full, meta) {
                                    if (data == true) {
                                        return '<center>Ya</center>'
                                    }
                                    else {
...
");
        ...
        $.ajax({
            ...
            WriteLiteral(@"ta,
                        ajax: {
                            ""url"": '../Onhold/LoadDataRiwayatKomentar',
                            ""type"": ""POST"",
                            ""datatype"": ""json"",
                            ""data"": { ""Id"": data },
                            error: function (jqXHR, textStatus, errorThrown) {
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""edit"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../Onhold/EditFasilitasKredit';
    ...
    function ViewDisclaimer(Id) {
        ...
        $.ajax({
            ...
            WriteLiteral(@"');
                    ...
                    State = ""edit"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../Onhold/ViewDisclaimer';
                    LoadPartialViewData(UrlPartialView, function (data) {
                        var modalbody = $('#LoadContent');
                        modalbody.html(data);
                        $('#ModalForm').modal({
            ...
            WriteLiteral(@"    if (hasil == true) {
                    ...
                    LoadPartialViewData(UrlPartialView, function (data) {
                        ...
                        $('#catatan').summernote({
                            ...
                            toolbar: [
                                ['style', ['style']],
                                ['font', ['bold', 'italic', 'underline', 'strikethrough', 'supersc");
            WriteLiteral(@"ript', 'subscript', 'clear']],
                                ['fontname', ['fontname']],
                                ['fontsize', ['fontsize']],
                                ['color', ['color']],
                        ...
                        Validatio");
            WriteLiteral(@"nForm(Id, ProspekId);
                    }, SearchData);
                }
                else {
                    window.location.href = ""../Login/Login?a=true"";
    ...
    function ValidationForm(Id, ProspekId) {
        ...
        var $validator = $(""#FormData"").validate({
            ...
            highlight: function (element) {
                $(elemen");
            WriteLiteral(@"t).closest('.form-group').removeClass('has-success').addClass('has-error');
            },
  ...
  ");
            WriteLiteral(@"      $.validator.messages.required = ""Harap isi field ini terlebih dahulu!"";
        ...
        $('#BtnApprove').click(function () {
            ...
            var id = $('#Id').val();
     ");
            WriteLiteral(@"       var $valid = $(""#FormData"").valid();
            if (!$valid) {
                //alert(""False"");
                $validator.focusInvalid();
                return false;
                ...
                $.ajax({
                    ...
                    success: function (hasil) {
                        if (hasil == true) {
                            $.ajax({
                                url: '../Onhold/Approve?catatan=' + catatan + '&id=' + Id,
                                type: 'POST',
        ...
        $('#BtnReject').click(function () {
            ...
            if (!$valid) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '../Login/C");
            WriteLiteral(@"ekSession',
                    success: function (hasil) {
                        if (hasil == true) {
                            $.ajax({
                                url: '../Onhold/Reject?catatan=' + catatan + '&id=' + Id,
                                type: 'POST',
                                data: $('#FormData').serialize(),
                                success: function (d) {
                                    //Tampilkan alert status
            ...
            if (!$valid) {
                ...
                $.ajax({
                    ...
                    success: function (hasil) {
                        if (hasil == true) {
                            $.ajax({
                                url: '../Onhold/Pending?catatan=' + catatan + '&id=' + Id,
                                type: 'POST',
                                data: $('#FormData').serialize()");
            WriteLiteral(@",
                                success: function (d) {
