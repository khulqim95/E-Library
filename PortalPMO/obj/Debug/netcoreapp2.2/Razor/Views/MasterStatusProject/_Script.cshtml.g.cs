#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\MasterStatusProject\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "465d4bb76300dfcea482264062b273ae4c7f5859"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_MasterStatusProject__Script), @"mvc.1.0.view", @"/Views/MasterStatusProject/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/MasterStatusProject/_Script.cshtml", typeof(AspNetCore.Views_MasterStatusProject__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"465d4bb76300dfcea482264062b273ae4c7f5859", @"/Views/MasterStatusProject/_Script.cshtml")]
    ...
    public class Views_MasterStatusProject__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
  ...
  ");
            WriteLiteral(@"                      retrieve: true,
                        ...
                        //data: data,
                        ajax: {
                            ""url"": '../MasterStatusProject/LoadData',
                            ""type"": ""POST"",
                            ""datatype"": ""json"",
  ...
  ");
    ...
    function Create() {
        ...
        State = ""create"";
        UrlPartialView = '../MasterStatusProject/Create';
    ...
    function Edit(Id) {
        ...
        $.ajax({
            ...
            WriteLiteral(@") {
                    ...
                    State = ""edit"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../MasterStatusProject/Edit';
                    LoadPartialViewData(UrlPartialView, function (data) {
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""view"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../MasterStatusProject/View';
                    LoadPartialViewData(UrlPartialView, function (data) {
                        $('#DivContentBody').hide();
                        document.getElementById(""DivFormBody"").innerHTML = data;
    ...
    function ValidationForm() {
        ...
        $('#BtnSubmit').click(function () {
            ...
            if (!$valid) {
                ...
                if (State == ""edit"") {
                    url = '../MasterStatusProject/SubmitEdit';
                ");
            WriteLiteral(@"}
                else {
                    url = '../MasterStatusProject/SubmitCreate';
                }
           ...
           swal({
            ...
            WriteLiteral(@""",
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '../MasterStatusProject/Delete',
                            type: 'POST',
                            data: { ""Ids"": Id },
                            success: function (d) {
                                if (d == """") {
