#pragma checksum "C:\work\E-Library\E-Library\PortalPMO\Views\DataKompleksitasProject\_Script.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "24fd8e5f69d5962e420a95ecdfc887d6783d89a6"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_DataKompleksitasProject__Script), @"mvc.1.0.view", @"/Views/DataKompleksitasProject/_Script.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/DataKompleksitasProject/_Script.cshtml", typeof(AspNetCore.Views_DataKompleksitasProject__Script))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"24fd8e5f69d5962e420a95ecdfc887d6783d89a6", @"/Views/DataKompleksitasProject/_Script.cshtml")]
    ...
    public class Views_DataKompleksitasProject__Script : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 15825, true);
  ...
  ");
            WriteLiteral(@"                      retrieve: true,
                        ...
                        //data: data,
                        ajax: {
                            ""url"": '../DataKompleksitasProject/LoadData',
                            ""type"": ""POST"",
                            ""datatype"": ""json"",
                        ...
                        columns: [
                            { responsivePriority: 1, ""data"": ""Number"", ""name"": ""Number"" },
                            {
                                ...
                                ""data"": ""Id"", ""name"": ""Id"", ""orderable"": false, ""visible"": true, ""render"": function (data, type, full, meta) {
                                    return '<div class=""btn-group""><a href=""javascript:void(0)"" class=""btn btn-small btn-facebook"" id=""button-ed");
            WriteLiteral(@"it"" onclick=""Edit(' + full.Id + ')"" style=""margin-right:5px;"" data-toggle=""tooltip"" title=""Ubah Data""><i class=""fa fa-edit btnEdit""></i></a>'
                            ...
                            { responsivePriority: 3, ""data"": ""KategoriKompleksitas"", ""name"": ""KategoriKompleksitas"" },
                            { responsivePriority: 4, ""data"": ""Kode"", ""name"": ""Kode"" },
                            { responsivePriority: 5, ""data"": ""Nama");
            WriteLiteral(@""", ""name"": ""Nama"" },
    ...
    function Create() {
        ...
        State = ""create"";
        UrlPartialView = '../DataKompleksitasProjec");
            WriteLiteral(@"t/Create';
            ...
            success: function (hasil) {
                if (hasil == true) {
                    LoadPartialViewData(UrlPartialView, function (data) {
                        ...
                        //DropdownKategoriProjectServerSide('KategoriKompleksitasId', 100, false);
                    });
                }
                else {
                    window.location.href = ""../Login/Login?a=true"";
  ...
  ");
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""edit"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../DataKompleksitasProject/Edit';
                    LoadPartialViewData(UrlPartialView, function (data) {
        ...
        $.ajax({
            ...
            success: function (hasil) {
                if (hasil == true) {
                    ...
                    State = ""view"";
                    SearchData = { ""Id"": Id }
                    UrlPartialView = '../DataKompleksitasProject/View';
                    LoadPartialViewData(UrlPartialView, function (data) {
                        $('#DivContentBody').hide();
                        document.getElementById(""DivFormBody"").innerHTML = data;
    ...
    function ValidationForm() {
        ...
        var $validator = $(""#FormData"").validate({
          ...
          ");
            WriteLiteral(@"  unhighlight: function (element) {
        ...
        //check apakah");
            WriteLiteral(@" form sudah valid atau belum
        $('#BtnSubmit').click(function () {
            ...
            if (!$valid) {
                ...
                if (State == ""edit"") {
                    url = '../DataKompleksitasProject/SubmitEdit';
                }
                else {
                    url = '../DataKompleksitasProject/SubmitCreate';
                }
        ...
        State = ""delete"";
           swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '../DataKompleksitasProject/Delete',
                            type: 'POST',
                            data: { ""Ids"": Id },
                            success: function (d) {
                                if (d == """") {
                                    NotifikasiSukses(""Sukses"", ""Data berhasil dihapu");
            WriteLiteral(@"s!"");
                                } else {
